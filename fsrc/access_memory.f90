...
use shared_data
    ...
    subroutine get_int_1d(name, origin)
        character(len=*), intent(in) :: name
        character(len=*), intent(in) :: origin
        integer(I4B) dim
    ...
    subroutine get_float_1d(name, origin)
        character(len=*), intent(in) :: name
        character(len=*), intent(in) :: origin
        integer(I4B) dim
    ...
    subroutine get_int_2d(name, origin)
        character(len=*), intent(in) :: name
        character(len=*), intent(in) :: origin
        integer(I4B):: ncol
        integer(I4B):: nrow
        ...
        call mem_setptr(ipointer, name, origin)
        ncol = size(ipointer, dim=1)
        nrow = size(ipointer, dim=2)
    ...
    subroutine get_float_2d(name, origin)
        character(len=*), intent(in) :: name
        character(len=*), intent(in) :: origin
        integer(I4B):: ncol
        integer(I4B):: nrow
        ...
        call mem_setptr(fpointer, name, origin)
        ncol = size(fpointer, dim=1)
        nrow = size(fpointer, dim=2)
